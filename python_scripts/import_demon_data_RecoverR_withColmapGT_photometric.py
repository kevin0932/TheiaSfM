...
def main():
    ...
    for image_pair12 in data.keys():
        ...
        relativePoses_outputGTfile.write("%s %s %s %s %s %s %s %f %f %f %f %f %f %f %f %f %f\n" % (image_pair12, image_indexGT_from_name1, images[image_name1], image_name1, image_indexGT_from_name2, images[image_name2], image_name2, relativePosesGT[imagePair_indexGT_12].qvec12[0], relativePosesGT[imagePair_indexGT_12].qvec12[1], relativePosesGT[imagePair_indexGT_12].qvec12[2], relativePosesGT[imagePair_indexGT_12].qvec12[3], relativePosesGT[imagePair_indexGT_12].tvec12[0], relativePosesGT[imagePair_indexGT_12].tvec12[1], relativePosesGT[imagePair_indexGT_12].tvec12[2], R_angleaxis[0], R_angleaxis[1], R_angleaxis[2]))
