...
def add_matches_noRt_exhaustivepairs(connection, cursor, image_id1, image_id2):
    dummy_matches = np.zeros([2,2])
...
def main():
    ...
    for image_pair12 in data.keys():
        ...
        # add_matches_noRt_exhaustivepairs(connectionNoRt, cursorNoRt, image_indexGT_from_name1, image_indexGT_from_name2)
