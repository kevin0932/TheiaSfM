...
def add_matches_withRt_photochecked(connection, cursor, image_id1, image_id2,
...
def main():
    ...
    for image_pair12 in data.keys():
        ...
        #img1PIL.show()
        #r, g, b = img1PIL.getpixel((0, 0))
        #print(r, g, b)
        #print("img1PIL.size", img1PIL.size)
        ...
        # image_pair12_rotmat = np.dot(imagesGT[image_indexGT_from_name2].rotmat, imagesGT[image_indexGT_from_name1].rotmat.transpose())
        # #image_pair12_transVec = np.dot(imagesGT[image_indexGT_from_name1].rotmat, (imagesGT[image_indexGT_from_name2].tvec - imagesGT[image_indexGT_from_name1].tvec))
        # image_pair12_transVec = np.dot(imagesGT[image_indexGT_from_name2].rotmat, (imagesGT[image_indexGT_from_name1].tvec - imagesGT[image_indexGT_from_name2].tvec))
        # #image_pair12_transVec = (imagesGT[image_indexGT_from_name2].tvec - imagesGT[image_indexGT_from_name1].tvec)
        # image_pair21_rotmat = np.dot(imagesGT[image_indexGT_from_name1].rotmat, imagesGT[image_indexGT_from_name2].rotmat.transpose())
        # #image_pair21_transVec = np.dot(imagesGT[image_indexGT_from_name2].rotmat, (imagesGT[image_indexGT_from_name1].tvec - imagesGT[image_indexGT_from_name2].tvec))
        # image_pair21_transVec = np.dot(imagesGT[image_indexGT_from_name1].rotmat, (imagesGT[image_indexGT_from_name2].tvec - imagesGT[image_indexGT_from_name1].tvec))

        # # https://math.stackexchange.com/questions/709622/relative-camera-matrix-pose-from-global-camera-matrixes
        # image_pair12_rotmat = np.dot(imagesGT[image_indexGT_from_name2].rotmat.transpose(), imagesGT[image_indexGT_from_name1].rotmat)
        # image_pair12_transVec = np.dot(imagesGT[image_indexGT_from_name2].rotmat.transpose(), (imagesGT[image_indexGT_from_name1].tvec - imagesGT[image_indexGT_from_name2].tvec))
        # image_pair21_rotmat = np.dot(imagesGT[image_indexGT_from_name1].rotmat.transpose(), imagesGT[image_indexGT_from_name2].rotmat)
        # image_pair21_transVec = np.dot(imagesGT[image_indexGT_from_name1].rotmat.transpose(), (imagesGT[image_indexGT_from_name2].tvec - imagesGT[image_indexGT_from_name1].tvec))

        # # by colmap convention, convert absolute poses to relative poses with quarternion vectors
        ...
        # #qvec1 = Quaternion(array=imagesGT[image_indexGT_from_name1].qvec)
        # #qvec2 = Quaternion(array=imagesGT[image_indexGT_from_name2].qvec)
        # #inv_qvec1 = qvec1.inverse
        # qvec1 = imagesGT[image_indexGT_from_name1].qvec
        # qvec2 = imagesGT[image_indexGT_from_name2].qvec
        # tvec1 = imagesGT[image_indexGT_from_name1].tvec
        # tvec2 = imagesGT[image_indexGT_from_name2].tvec
        # qvec12, image_pair12_transVec = relativePose_from_AbsolutePose(qvec1, tvec1, qvec2, tvec2)
        # qvec21, image_pair21_transVec = relativePose_from_AbsolutePose(qvec2, tvec2, qvec1, tvec1)
        # print("image_pair12_transVec = ", image_pair12_transVec)
        # print("image_pair21_transVec = ", image_pair21_transVec)
        ...
        # #print(type(image_pair12_rotmat))
        # #print(image_pair12_rotmat.shape)
        # #print(type(image_pair12_transVec))
        # #print(image_pair12_transVec.shape)

        qvec12 = relativePosesGT[imagePair_indexGT_12].qvec12
        qvec21 = relativePosesGT[imagePair_indexGT_21].qvec12
        image_pair21_rotmat = quaternion2RotMat(qvec12[0], qvec12[1], qvec12[2], qvec12[3])
        image_pair12_rotmat = quaternion2RotMat(qvec21[0], qvec21[1], qvec21[2], qvec21[3])
        image_pair21_transVec = relativePosesGT[imagePair_indexGT_12].tvec12
        image_pair12_transVec = relativePosesGT[imagePair_indexGT_21].tvec12
        ...
        add_matches_withRt_photochecked(connection, cursor, images[image_name1], images[image_name2], flow12, flow21, args.max_reproj_error, R_angleaxis, image_pair12_transVec, args.max_photometric_error, img1PIL, img2PIL)
